#pragma message("#include \"unitree_joint_controller_parameters.hpp\" is deprecated. Use #include <unitree_joint_controller/unitree_joint_controller_parameters.hpp> instead.")
...
#include "validate_ujc_parameters.hpp"
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("unitree_joint_controller"), prefix) {
    ...
    void refresh_dynamic_parameters() {
      ...
      for (const auto & value_1 : updated_params.joints) {
          ...
          if (!parameters_interface_->has_parameter(param_name)) {
              rcl_interfaces::msg::ParameterDescriptor descriptor;
              descriptor.description = "For joints that wrap around (ie. are continuous). Normalizes position-error to -pi to pi.";
              descriptor.read_only = false;
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        ...
        if (param.get_name() == (prefix_ + "command_interfaces")) {
            ...
            if(auto validation_result = unitree_joint_controller::command_interface_type_combinations(param);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
        ...
        if (param.get_name() == (prefix_ + "state_interfaces")) {
            ...
            if(auto validation_result = unitree_joint_controller::state_interface_type_combinations(param);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
