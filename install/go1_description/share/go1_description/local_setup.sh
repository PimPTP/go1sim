...
: ${AMENT_CURRENT_PREFIX:="/home/pim0ubuntu/go1_ws/install/go1_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go1_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go1_description/environment/path.sh"
